...
Подборка актуальных материалов для ручного и автоматического трейдинга криптовалюты. 

Не стесняйтесь добавлять и обновлять информацию через ```Pull requests```, мы будем рады вашему участию.

Если у вас останутся вопросы, вы всегда их сможете задать в [телеграм-канале "Криптоглупости" @CryptoStupidity](https://t.me/CryptoStupidity)
