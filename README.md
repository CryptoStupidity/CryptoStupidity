...
[Страница оплаты](http://cryptostupidity.com/#second-section)
...
С нами можно заработать! Приглашайте друзей на [тренинг "Автоматическая и ручная торговля на крипто-бирже"](http://course.cryptostupidity.com/) и получайте 10% от платежей. Это поможет пройти обучение бесплатно и будет приносить пассивный доход.
