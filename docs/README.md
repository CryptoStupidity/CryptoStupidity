...
Мы проводим [практический тренинг](http://cryptostupidity.com/), в котором учим делать технический анализ и торговать ботами, обращайтесь, всему научим.
...
Подробную информацию о текущей [стоимости тренинга можно найти на сайте](http://cryptostupidity.com/)
...
[Ответы на вопросы, которые часто задают по тренингу](course.md#Ответы-на-частые-вопросы)

[Оплатить тренинг](http://cryptostupidity.com/#second-section) принимаем крипту, фиатные деньги.
...
С нами можно заработать. Приглашайте друзей на [тренинг "Автоматическая и ручная торговля на крипто-бирже"](http://course.cryptostupidity.com/) и получайте 10% от платежей. Возможно это поможет пройти обучение именно вам совершенно бесплатно, а возможно даст неплохой доход.
